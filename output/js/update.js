...
var coursesUpdateAPI = 'http://localhost:8000/api/admin/post';
var coursesDeleteAPI = 'http://localhost:8000/api/admin/post';
...
function handleUpdateCourse() {
    var updateBtn = document.querySelector('#btnUpdate');
